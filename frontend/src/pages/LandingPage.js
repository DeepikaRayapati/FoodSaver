    ...
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              {isAuthenticated ? (
                <Link to="/dashboard" className="btn btn-outline text-lg px-8 py-3 inline-flex items-center justify-center">
                  Go to Dashboard
                </Link>
              ) : (
      ...
      <section className="py-20 bg-green-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            {isAuthenticated ? (
              <Link to="/dashboard" className="btn bg-white text-green-600 hover:bg-gray-100 text-lg px-8 py-3 inline-flex items-center justify-center">
                Go to Dashboard
                <ArrowRight className="ml-2 w-5 h-5" />
              </Link>
            ) : (
