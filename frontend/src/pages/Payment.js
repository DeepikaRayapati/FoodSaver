...
import { ArrowLeft, QrCode, CreditCard, Smartphone, Copy, CheckCircle, AlertCircle } from 'lucide-react';
...
const Payment = () => {
  ...
  const vendorPaymentDetails = {
    ...
    scannerImage: listing.vendor?.paymentScanner || '/images/sample-qr-code.png',
    upiId: `${listing.vendor?.name?.toLowerCase().replace(/\s+/g, '')}@pay`,
